...
_0x0:
	...
	.DB  0x3D,0x3D,0x3D,0x3D,0x3D,0x3D,0x3D,0x3D
	.DB  0x3D,0x3D,0x3D,0x3D,0x0,0x7C,0x20,0x25
	.DB  0x30,0x34,0x64,0x2F,0x25,0x30,0x32,0x64
	.DB  0x2F,0x25,0x30,0x32,0x64,0x20,0x7C,0x0
	.DB  0x7C,0x20,0x20,0x25,0x30,0x32,0x64,0x3A
	.DB  0x25,0x30,0x32,0x64,0x3A,0x25,0x30,0x32
	.DB  0x64,0x20,0x20,0x7C,0x0
...
;int s,m,h,day=01,month=01,year=1404;
...
; 0000 001F     printf("====================");
	CALL SUBOPT_0x0
; 0000 0020     putchar(13);
	CALL SUBOPT_0x1
; 0000 0021     sprintf(WT,"| %04d/%02d/%02d |",year,month,day);
; 0000 0022     puts(WT);
; 0000 0023     sprintf(WT,"|  %02d:%02d:%02d  |",h,m,s);
; 0000 0024     puts(WT);
; 0000 0025     putchar(13);
; 0000 0026     printf("====================");
	CALL SUBOPT_0x0
; 0000 0027     putchar(13);
	RJMP _0x2060003
; 0000 0028 }
; .FEND
;void Showf(){
; 0000 0029 void Showf(){
_Showf:
; .FSTART _Showf
; 0000 002A     puts(      "====================");
	__POINTW2MN _0x4,0
	CALL _puts
; 0000 002B     putchar(13);
	CALL SUBOPT_0x1
; 0000 002C     sprintf(WT,"| %04d/%02d/%02d |",year,month,day);
; 0000 002D     puts(WT);
; 0000 002E     sprintf(WT,"|  %02d:%02d:%02d  |",h,m,s);
; 0000 002F     puts(WT);
; 0000 0030     putchar(13);
; 0000 0031     puts(      "====================");
	__POINTW2MN _0x4,21
	CALL _puts
; 0000 0032     putchar(13);
_0x2060003:
	LDI  R26,LOW(13)
	RCALL _putchar
; 0000 0033 }
...
_0xA:
	RJMP _0x9
_0xB:
; 0000 004B         if(day>=30){month++;day=0;}
	LDI  R30,LOW(30)
	LDI  R31,HIGH(30)
	CP   R10,R30
	CPC  R11,R31
...
; 0000 004C     }
_0xC:
; 0000 004D     else if(month>=7&&month<=12){
	RJMP _0xD
_0x9:
	LDI  R30,LOW(7)
	LDI  R31,HIGH(7)
...
_0xF:
	RJMP _0xE
_0x10:
; 0000 004E         if(day>=31){month++;day=0;}
	LDI  R30,LOW(31)
	LDI  R31,HIGH(31)
	CP   R10,R30
	CPC  R11,R31
...
; .FEND
;void Settime(){
; 0000 0059 void Settime(){
_Settime:
; .FSTART _Settime
; 0000 005A     if(PINB.1==0){
	SBIC 0x16,1
	RJMP _0x13
; 0000 005B         m++;
	MOVW R30,R6
...
; 0000 0070         Showf();
	RCALL _Showf
; 0000 0071      }
; 0000 0072     if(PINB.7==0){
_0x18:
	SBIC 0x16,7
	RJMP _0x19
; 0000 0073         s=0;
	CALL SUBOPT_0x2
; 0000 0074         m=0;h=0;day=01;month=01;year=1404;
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	MOVW R10,R30
	MOVW R12,R30
...
; 0000 00D2 // USART Mode: Asynchronous
; 0000 00D3 // USART Baud Rate: 1200
; 0000 00D4 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 00D5 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(24)
	OUT  0xA,R30
; 0000 00D6 UCSRC=(1<<URSEL) | (0<<UMSEL) | (0<<UPM1) | (0<<UPM0) | (0<<USBS) | (1<<UCSZ1) | (1<<UCSZ0) | (0<<UCPOL);
	LDI  R30,LOW(134)
	OUT  0x20,R30
; 0000 00D7 UBRRH=0x00;
	LDI  R30,LOW(0)
	OUT  0x20,R30
; 0000 00D8 UBRRL=0x33;
	LDI  R30,LOW(51)
	OUT  0x9,R30
; 0000 00D9 
...
; 0000 00E5 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 00E6 
...
;OPTIMIZER ADDED SUBROUTINE, CALLED 2 TIMES, CODE SIZE REDUCTION:66 WORDS
SUBOPT_0x1:
	LDI  R26,LOW(13)
	CALL _putchar
	LDI  R30,LOW(_WT)
